...
public class ChessGui extends JFrame {
    ...
    private final int WIDTH = 60; // szerokość pola
    private final int HEIGHT = 60; // wysokość pola
    ...
    public ChessGui() {
        ...
        for (int row = 0; row < 8; row++) {
            ...
            verticalLabel.setFont(new Font("Century Gothic Bold", Font.PLAIN, 15));
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (clickedRow == -1 && clickedCol == -1) {
                            ...
                            if (true) {
                                ...
                                figura tymczasowa = sz.getFigure(clickedCol, clickedRow);
                                sz.removeFigure(clickedCol, clickedRow);
                                sz.placeFigure(finalCol, finalRow, tymczasowa);
                                if(szachownica[clickedCol][clickedRow].getColor() == "czarny"){
                                    squares[clickedRow][clickedCol].setBackground(Color.DARK_GRAY);
                                }
                                else{
        ...
        for (int i = 0; i < 8; i++) {
            ...
            label.setFont(new Font("Century Gothic Bold", Font.PLAIN, 15));
